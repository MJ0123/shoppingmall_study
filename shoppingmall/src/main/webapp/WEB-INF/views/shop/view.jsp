...
<script>
	 function replyList() {
		...
		// $.getJSON()은 비동기식으로 JSON 데이터를 가져오는 메서드
		// http:///shop/view/replyList" + "?n=" + gdsNum 주소로 컨드롤러에 접속하여 데이터를 가져오고,
		// 그 데이터를 이용해 HTML 코드를 조립하여 <ol> 태그에 추가하는 방식
		$.getJSON("/shop/view/replyList" + "?n=" + gdsNum, function(data){
			...
			$(data).each(function(){
				...
				// 컨트롤러에서 toLocaleDateString()을 이용해 1차적으로 데이터를 가공함
				...
				<div id="reply">
					...
					<section class="replyForm">
						<form role="form" method="post" autocomplete="off">
							...
							<div class="input_area">
								<button type="button" id="reply_btn">상품평 남기기</button>
					...
					<section class="replyList">
						...
						<script>
							// 상품평 목록은 스크립트로 인해 생성된 동적인 HTML코드로 .on()메서드를 사용해야함
